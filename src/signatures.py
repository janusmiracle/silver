...
SIGNATURES = (
    Signature(
        Format("WAVE", "Type [WAVE] derived from [RIFF]", "little"),
        b"\x52\x49\x46\x46\x57\x41\x56\x45",
        4,
    ),
    Signature(
        Format("WAVE", "Type [WAVE] derived from [RF64]", "little"),
        b"\x52\x46\x36\x34\x57\x41\x56\x45",
        4,
    ),
    Signature(
        Format("WAVE", "Type [WAVE] derived from [BW64]", "little"),
        b"\x42\x57\x36\x34\x57\x41\x56\x45",
        4,
    ),
    Signature(
        Format("WAVE", "Type [WAVE] derived from [RIFX]", "big"),
        b"\x52\x49\x46\x58\x57\x41\x56\x45",
        4,
    ),
    Signature(
        Format("WAVE", "Type [WAVE] derived from [FFIR]", "big"),
